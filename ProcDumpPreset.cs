...
public sealed class ProcDumpPreset
{
    ...
    private ProcDumpPreset(string name, string description, string effectiveFlags, Action<Config> apply)
    {
        Name = name;
    ...
    public static IReadOnlyList<ProcDumpPreset> All { get; } = new ProcDumpPreset[]
    {
        new("Crash capture",
    ...
    public static ProcDumpPreset? FindByName(string name) =>
